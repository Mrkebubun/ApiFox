function AppViewModel(dataModel) {
    ...
    self.addViewModel = function (options) {
        ...
        self[options.bindingMemberName] = ko.computed(function () {
            if (common.getFragment().access_token)
                dataModel.setAccessToken('');

            if (!dataModel.getAccessToken() || dataModel.getAccessToken() == '') {
                ...
                if (fragment.access_token) {
                    ...
                    console.log('fragment.access_token: ' + fragment.access_token);
                } else {
